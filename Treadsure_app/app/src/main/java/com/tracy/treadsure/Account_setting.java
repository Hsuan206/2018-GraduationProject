...
public class Account_setting extends AppCompatActivity {
    ...
    String name,cellphone,email,locate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.account_appBar);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChild("image")) {
                    ...
                    if(!image.equals("default")) {
                        ...
                        Picasso.with(Account_setting.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                            ...
                            public void onError() {
                                ...
                                Picasso.with(Account_setting.this).load(image).placeholder(R.drawable.user_person_before).into(mDisplayImage);
                            }
                        });
                    }
                }
        ...
        mStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent status_intent = new Intent(Account_setting.this,StatusActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProgressDialog = new ProgressDialog(Account_setting.this);
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        ...
                        if(task.isSuccessful()) {
                            ...
                            uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task) {
                                    ...
                                    if(thumb_task.isSuccessful()) {
                                        ...
                                        mUserDatabase.updateChildren(update_hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(Account_setting.this,"上傳成功",Toast.LENGTH_LONG).show();
                                        ...
                                        Toast.makeText(Account_setting.this,"上傳快取失敗",Toast.LENGTH_LONG).show();
                                        mProgressDialog.dismiss();
                            ...
                            Toast.makeText(Account_setting.this,"上傳失敗",Toast.LENGTH_LONG).show();
                            mProgressDialog.dismiss();
                        }
